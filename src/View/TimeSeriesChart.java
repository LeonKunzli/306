...
/**
 * GUI - Klasse für die Darstellung der XML-Files
 *
 * Vorlage von JFreeChart: https://github.com/jfree/jfree-demos/releases/tag/v2.0
 *
 * @author Saam Eymany
 * @version 1.0
 * @since 2021-10-04
...
public class TimeSeriesChart extends ApplicationFrame {
    ...
    public static void main(String[] args) {
        ...
        TimeSeriesChart demo = new TimeSeriesChart(
